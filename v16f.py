...
#    index=16
    ...
    for i in range(np.shape(plot1)[1]):
        dist1.append(plot1.iloc[dex][i][0])
        dist2.append(plot2.iloc[dex][i][0]) 
        dist3.append(plot3.iloc[dex][i][0])
        dist4.append(plot4.iloc[dex][i][0])
        dist5.append(plot5.iloc[dex][i][0])
        dist6.append(plot6.iloc[dex][i][0])
        dist7.append(plot7.iloc[dex][i][0])
        dist8.append(plot8.iloc[dex][i][0])
        dist9.append(plot9.iloc[dex][i][0])
        dist10.append(plot10.iloc[dex][i][0])
