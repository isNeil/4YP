...
def v15():
    ...
    return [dist3,dist3p,dist4,dist4p,dist5,dist5p,dist6,dist6p,dist7,dist7p,dist8,dist8p,dist9,dist9p,dist10,dist10p]
    ...
    def plot(dist3,dist3p,color,color2,space):
        ...
        for i in range(len(dist3)):
            ...
            plt.plot(x,y2, color2, alpha=0.4)
