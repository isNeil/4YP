...
def v10(index):
    ...
    accel4=np.subtract(accel4,accel3)
    accel5=np.subtract(accel5,accel3)
    accel6=np.subtract(accel6,accel3)
    accel7=np.subtract(accel7,accel3)
    accel8=np.subtract(accel8,accel3)
    accel9=np.subtract(accel9,accel3)
    accel10=np.subtract(accel10,accel3)
    accel3=np.subtract(accel3,accel3)
...
#     
#    plt.show()
    df = pd.DataFrame(np.array([accel3,accel4,accel5,accel6,accel7,accel8,accel9,accel10]))
