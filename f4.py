...
for i in range(np.shape(plot1)[1]):
    plot1x.append(plot1.iloc[dex][i][0]-plot2.iloc[dex][i][0])
    plot1y.append(plot1.iloc[dex][i][1]-plot2.iloc[dex][i][1])
    plot1z.append(plot1.iloc[dex][i][2]-plot2.iloc[dex][i][2])
