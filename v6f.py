...
def v6(index):
   ...
   #######################################Below this should be a function but for now just do x
    ...
    dist1 = savgol_filter(temp1, 21, 3)
    dist2 = savgol_filter(temp2, 21, 3)  
    dist3 = savgol_filter(temp3, 21, 3)  
    dist4 = savgol_filter(temp4, 21, 3)  
    dist5 = savgol_filter(temp5, 21, 3)  
    dist6 = savgol_filter(temp6, 21, 3)  
    dist7 = savgol_filter(temp7, 21, 3)  
    dist8 = savgol_filter(temp8, 21, 3)  
    dist9 = savgol_filter(temp9, 21, 3)  
    dist10 = savgol_filter(temp10, 21, 3)  
