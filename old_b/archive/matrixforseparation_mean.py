...
output_mean,output_var = pickle.load(open("differencematrices.p","rb"))
...
img = ax.imshow(output_mean_formatted, cmap=cmap)
...
fig.savefig("Images/MEASUREmatrix.jpg", dpi=200) 
