...
#
#
#ax.scatter(plot1x, plot1y, [-400]*np.shape(plot1)[1], zdir='z',alpha=0.2,c=rgbc) #cmap=cm.coolwarm)
#ax.scatter([-700]*np.shape(plot1)[1], plot1y, plot1z, zdir='z',alpha=0.2,c=rgbc) #cmap=cm.coolwarm)
#ax.scatter(plot1x, [700]*np.shape(plot1)[1],  plot1z, zdir='z',alpha=0.2,c=rgbc) #cmap=cm.coolwarm)
